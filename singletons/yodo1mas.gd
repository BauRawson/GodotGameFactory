...
func initialize_Yodo1MAS():
	if Engine.has_singleton("GodotYodo1Mas"):
		...
		if OS.get_name() == "iOS":
			...
			print("Yodo1MAS initialized -- iOS")
		elif OS.get_name() == "Android":
			_yodo1mas_singleton.init(app_id_android)
			print("Yodo1MAS initialized -- Android")
		else:
			print("Yodo1MAS not initializing because it's not Android or iOS")
